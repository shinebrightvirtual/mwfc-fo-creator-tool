...
const COLUMNS = [
  "Oil Name","Midwest Maker Signature Scent?","Type?","Renamed?","Description","Top Notes","Middle Notes","Base Notes","Alt Naming Ideas",
...
const KEY_TO_COL = {
  "name":"Oil Name","original":"Midwest Maker Signature Scent?","is_type":"Type?","renamed":"Renamed?","desc":"Description",
